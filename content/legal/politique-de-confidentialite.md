...
Tout ce qui suit est enregistré chez **Supabase**, qui héberge notre base de données et gère votre connexion. Chaque table porte une règle de sécurité au niveau de la ligne : la base elle-même refuse de rendre vos lignes à quelqu'un d'autre, indépendamment du code de l'application. Ces règles sont actives sur les 24 tables du schéma.

| Ce qui est enregistré                                                    | Contenu exact                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | D'où cela vient                                                                        |
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| **Votre compte** _(géré par Supabase Auth)_                              | Votre adresse e-mail. Pour les comptes qui ont un mot de passe, son empreinte, détenue par Supabase — l'application n'en crée aucun et n'y accède jamais. Si vous entrez par **Google ou LinkedIn**, s'y ajoutent l'identifiant technique de votre compte chez ce fournisseur et le nom d'affichage qu'il transmet — jamais vos contacts, vos publications ni votre historique.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Vous                                                                                   |
...
| **Votre abonnement au récapitulatif** _(`digest_subscriptions`)_         | Un oui/non, la date du dernier envoi, et un jeton aléatoire qui sert uniquement au lien « se désabonner » — il n'authentifie personne et n'ouvre aucune donnée. **Par défaut, c'est non.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Vous                                                                                   |
| **Les offres que vous écartez** _(`offer_dismissals`)_                   | **Un compteur par motif, et rien d'autre.** Quand vous cliquez « pas pour moi » sur une offre, nous enregistrons _lequel des cinq motifs_ vous avez choisi — pas le bon métier, trop junior, trop senior, mauvais endroit, mauvais type de contrat — et nous ajoutons 1 au compteur correspondant. **L'offre elle-même n'est jamais enregistrée** : ni son titre, ni l'entreprise, ni le lien, ni aucun identifiant. La table ne comporte que trois colonnes — votre profil, le motif, le compteur — et aucune ne peut désigner une annonce. Il n'y a pas non plus d'horodatage : nous ne tenons aucune chronologie de ce que vous refusez et quand. Les motifs forment une liste fermée : aucun texte libre ne peut y entrer.                                                                                                                                                                                                  | Vous, en cliquant                                                                      |
...
| **Vos variantes de CV** _(`cv_variants`)_                                | Le nom de chaque variante (« Design Lead », « Product Lead »…), son intitulé, vos règles « quand l'utiliser » écrites par vous, le nom exact du fichier que vous joignez à vos candidatures, la langue. Le brouillon de candidature enregistre quelle variante il accompagne et pourquoi — jamais le fichier lui-même, qui ne quitte pas votre machine. Table dormante tant que l'écran de candidature n'est pas ouvert.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Vous                                                                                   |
| **Votre contrat de ton** _(`tone_contracts`)_                            | Vos règles de voix écrites par vous (registre, longueur de phrase, ce qu'il faut éviter), le nom de signature, une formule d'appel et une formule de politesse finale en français et en anglais, et vos propres formules interdites en plus de la liste générique intégrée à l'application. **En ajout seul : publier une nouvelle version n'efface ni ne modifie jamais la précédente**, et le brouillon de candidature enregistre exactement sous quelle version il a été écrit. Table dormante : aucun écran ne permet encore d'en publier une version — le mécanisme sait la lire dès qu'une ligne existe, et applique un ton générique par défaut tant qu'il n'y en a pas.                                                                                                                                                                                                                                                 | Vous                                                                                   |
| **Votre registre d'envois** _(`application_dispatches`)_                 | Une ligne par candidature que **vous** avez envoyée : l'offre concernée, le canal (approche directe, portail, agence, recommandation, entrant), le destinataire tel que vous l'écrivez (320 caractères) — **une donnée qui concerne une autre personne, voir section 7** — accompagné d'une forme normalisée (minuscules, sans espaces de bord) qui sert uniquement à reconnaître un doublon, la date d'envoi, la variante de CV jointe, l'état de remise et la date à laquelle vous l'avez vérifié, la date et la nature d'une réponse reçue, et votre note (2 000 caractères). **Le produit n'envoie rien et ne lit aucune boîte mail** : c'est vous qui enregistrez ce qui est parti, et l'état de remise reste « inconnu » tant que vous ne le renseignez pas. Deux envois le même jour, sur la même offre et par le même canal, sont refusés par la base. Table dormante tant que l'écran de candidature n'est pas ouvert. | Vous                                                                                   |
| **Votre abonnement payant** _(`subscriptions`)_                          | Votre formule, son statut, la fin de la période en cours, et les identifiants techniques de votre abonnement et de votre fiche client chez Polar, notre prestataire de paiement. Aucune donnée bancaire : elle reste chez Polar. Table dormante tant que le paiement n'est pas ouvert.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Vous / Polar                                                                           |
| **Le journal des paiements** _(`billing_events`)_                        | La copie brute de chaque notification envoyée par Polar (type d'événement, horodatage, contenu technique), conservée pour qu'une notification livrée deux fois ne soit traitée qu'une seule fois. Ce journal n'est relié à aucun compte dans la base et n'est lisible par aucun utilisateur. Table dormante tant que le paiement n'est pas ouvert.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Polar                                                                                  |
...
**Les offres que vous importez, en revanche, sont écrites.** Consulter et importer sont deux gestes différents, et nous ne les traitons pas pareil. Tant que vous parcourez des annonces, rien n'est enregistré. Le jour où vous en retenez une — pour préparer une candidature, la suivre, ou enregistrer un envoi dans votre registre — elle est écrite en base, parce qu'un suivi qui ne retient pas ce qu'il suit n'existe pas. Elle s'efface avec votre compte. Ces tables sont aujourd'hui vides : aucun écran ne permet encore d'importer une offre.
...
Quand vous enregistrez un envoi dans votre registre de candidatures, vous nous transmettez le **destinataire** tel que vous l'écrivez : un nom de recruteur, un cabinet, ou une adresse e-mail professionnelle. C'est également la donnée d'une autre personne.
...
- **Destinataire d'un envoi** : nous l'enregistrons dans votre registre, dans le champ que vous remplissez. Il sert uniquement à vous rappeler à qui vous avez écrit et à empêcher un doublon. **Il ne part chez aucun sous-traitant** : il n'entre ni dans le dossier professionnel envoyé à OpenAI (section 9), ni dans le récapitulatif hebdomadaire (section 11.3). Nous ne le recoupons avec rien, et nous n'en constituons aucun annuaire.
...
**Base légale** : notre intérêt légitime (art. 6(1)(f)) à vous permettre de documenter votre parcours par les appréciations que vous avez reçues, et à tenir la trace de vos propres démarches. La mise en balance tient compte du fait que ces données ne sont ni publiées, ni transmises à un employeur, ni utilisées pour profiler leur auteur ou leur destinataire. Pour le destinataire d'un envoi, elle tient compte en outre du fait qu'il s'agit d'une coordonnée professionnelle, dans le cadre d'un échange qu'il a lui-même reçu de vous, conservée dans un registre visible de vous seul.
...
**Si vous êtes l'auteur d'une recommandation, ou le destinataire d'une candidature** enregistré ici par la personne concernée : le responsable du traitement est Productions Associées (section 2), la source de vos données est cette personne, la finalité est celle décrite ci-dessus, la durée est celle de la section 14, et vous disposez des droits de la section 15. Écrivez à **cve@hi-def.be** : nous répondons dans le mois. Nous n'informons pas aujourd'hui individuellement les auteurs de recommandations ni les destinataires enregistrés ; cette section est l'information que nous rendons publiquement disponible (art. 14(5)(b)).
...
| **Supabase**                                                                  | Toutes les données de la section 3. C'est notre base de données, notre système d'authentification, l'émetteur de vos cookies de session et le point de départ de vos liens de connexion                                                                                          | Sous-traitant (art. 28)                                                                                                    |
| **Resend**                                                                    | **Votre adresse e-mail, et le contenu des messages que nous vous envoyons.** C'est le service qui achemine nos e-mails : vos liens de connexion, et — si vous l'avez demandé — le récapitulatif hebdomadaire décrit en section 12. Il ne reçoit ni votre CV, ni votre profil     | Sous-traitant (art. 28)                                                                                                    |
...
| **Google / LinkedIn** _(seulement si vous choisissez ce mode de connexion)_   | Le fournisseur apprend que vous utilisez MissionPilot, à chaque connexion — c'est inhérent au mécanisme, et c'est la seule chose qu'il apprend de nous. En retour, il nous transmet votre adresse e-mail, votre nom d'affichage et un identifiant technique                      | **Responsable de traitement distinct** — ce qu'il fait de cette information relève de sa propre politique, pas de la nôtre |
...
| -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Création du compte, connexion — par lien magique, mot de passe, **Google ou LinkedIn** | Vous identifier et vous donner accès à votre profil. Les trois chemins mènent à la même session ; aucun ne donne plus de droits qu'un autre | **Art. 6(1)(b)** — exécution du contrat                                                                                                                                                             |
...
| **Récapitulatif hebdomadaire par e-mail**                                              | Vous écrire une fois par semaine ce que le marché a ouvert pour vous, **seulement si nous avons trouvé quelque chose**                      | **Art. 6(1)(a)** — votre consentement. Il n'est jamais présumé : rien ne part tant que vous ne l'avez pas demandé depuis votre compte, et chaque message porte un lien pour arrêter, sans connexion |
...
| Offres importées, et le registre des envois qui s'y rattache                                                                                       | **Jusqu'à ce que vous supprimiez votre compte.** Écrites seulement si vous retenez une offre ; tables vides tant que l'écran de candidature n'est pas ouvert |
...
- **Cloisonnement par utilisateur** : les 24 tables du schéma portent une règle de sécurité au niveau de la ligne. Le contrôle est fait par la base, pas par l'application. Cette isolation est couverte par des tests automatisés.
